...
<html>
	<head>
		<title>Russel by HTML5 UP</title>
		<meta charset="utf-8" />
						...
						<!-- Panel (Banner) -->
							<section class="panel banner right">
								<div class="content color4-alt span-3-75">
									...
									is Russel</h1>
									<p>This is a <strong>FREE</strong> site template by AJ for <a href="https://html5up.net">HTML5 UP</a>. It’s fully responsive, built on HTML5 and CSS3, and released entirely for free under the Creative Commons license. Hope you dig it :)</p>
									<ul class="actions">
										<li><a href="#first" class="button primary color1 circle icon solid fa-angle-right">Next</a></li>
									</ul>
								</div>
								<div class="image filtered span-1-75" data-position="25% 25%">
									<img src="sel_01.jpg" alt="" />
								</div>
							</section>

						<!-- Panel (Spotlight) -->
							<section class="panel spotlight medium right" id="first">
								<div class="content span-20-30">
									<h2 class="major"><a href="https://comit.org">ComIT</a></h2>
									<p>I'm one of the student of ComIT with the course of DevOps-BC Batch of May 20, 2020. It was conducted by Pablo and Emerson. ComIT is a charity which aims to develop a community that links people struggling to overcome employment barriers with companies look for talented IT professionals.</p>
									<iframe width="560" height="315" src="https://www.youtube.com/embed/iEVgnrRgQW8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								</div>
								<div class="image filtered tinted" data-position="top left">
									<img src="sel_02.jpg" alt="" />
								</div>
							</section>
						...
						<!-- Panel (Spotlight) -->
							<section class="panel spotlight large left">
								<div class="content span-5">
									...
									<p><strong>Name: </strong>Russel Robert B. Caballero</p>
									<p><strong>Age: </strong>25 yrs.</p>
									<p><strong>Address:</strong>North Vancouver, BC Canada</p>
									<p><strong>Email: </strong>caballerorussel@yahoo.com</p>
									<a href="https://www.facebook.com/sel.caballero7/">
